# Generated by Powerlevel10k configuration wizard on 2025-08-12 at 01:15 EDT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 37983.
# Wizard options: powerline, ascii, lean, 2 lines, dotted, dark-ornaments, sparse,
...
() {
  ...
  # Display prompt char in bold.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_BOLD=true
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local     staged='%B%2F'  # green foreground
      local    stashed='%B%3F'  # yellow foreground
      local    branchc='%B%5F'  # purple foreground
      ...
      local    branchc='%244F'  # grey foreground
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="${branchc}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}"
    fi
  ...
  # typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_PREFIX='%fas '
  ...
  # show shell+prompt_char as transient prompt
  # see https://github.com/romkatv/powerlevel10k/issues/316#issuecomment-551867287 for docs
  # see https://github.com/romkatv/powerlevel10k/issues/334 for "smart" mode
  function p10k-on-pre-prompt() {
    [[ $P9K_TTY == old ]] && p10k display 'empty_line'=show
    p10k display '1|2/left'=show '1|2/right'=show
  }
  function p10k-on-post-prompt() {
    local current_prompt_dir=$PWD
    local current_python_bin="$commands[python]"
    local current_vcs_state="$VCS_STATUS_COMMIT:$VCS_STATUS_LOCAL_BRANCH:$VCS_STATUS_NUM_UNSTAGED:$VCS_STATUS_NUM_STAGED_NEW:$VCS_STATUS_NUM_STAGED_DELETED"
